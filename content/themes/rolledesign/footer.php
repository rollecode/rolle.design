...
<footer id="colophon" class="block block-has-space block-my-things site-footer has-light-bg">
  ...
  <div class="head">
    ...
    <h2><a href="https://github.com/rollecode" class="no-external-link-indicator">Follow my projects on GitHub. <?php include get_theme_file_path( '/svg/github.svg' ); ?></a></h2>
  </div>
